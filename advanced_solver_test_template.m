...
function advanced_solver_test_template()
    ...
    % 
    % x_sol = newton(@test_func01,x0_guess,dxtol,ftol,max_iter,dxmax);
    ...
    % 
    % x_sol = secant(@test_func01,x0_guess,x1_guess,dxtol,ftol,max_iter,dxmax);
    % plot(x_sol,test_func01(x_sol),'go','markerfacecolor','g','markersize',5);
    ...
    x_sol = bisection(@test_func01,x_left,x_right,dxtol,ftol,max_iter);
    plot(x_sol,test_func01(x_sol),'go','markerfacecolor','g','markersize',5);
end
